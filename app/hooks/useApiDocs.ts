...
export const SCHEMA_EXAMPLE = `// Complete Portfolio Schema
{
  userInfo: {
    name: string,
    title: string,
...
const useApiDocs = () => {
  ...
  const getActiveEndpoint = useCallback(() => API_ENDPOINTS[activeEndpoint], [activeEndpoint]);
  ...
  return {
    ...
    // Computed
    currentEndpoint: getActiveEndpoint(),
  };
};
