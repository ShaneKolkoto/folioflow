const steps = [
  {
    ...
    description: 'Register for free and build your CV using our intuitive editor.',
  },
  {
    number: '2',
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mt-20">
          <div className="relative">
            {/* Connecting line */}
            <div className="absolute left-4 top-0 h-full w-0.5 bg-gray-200 md:left-1/2 md:-ml-0.5" />
