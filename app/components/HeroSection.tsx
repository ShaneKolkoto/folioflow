  ...
  return (
    <section className="relative overflow-hidden min-h-screen">
        ...
        <div className="text-center relative z-10">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="inline-flex items-center justify-center rounded-lg bg-blue-600 px-8 py-3 text-lg font-medium text-white hover:bg-blue-700 transition-colors shadow-lg hover:shadow-xl z-10 relative"
            >
              Start Building Free
            </Link>
            <Link
              href="/api-demo"
              className="inline-flex items-center justify-center rounded-lg border border-gray-300 px-8 py-3 text-lg font-medium text-gray-700 hover:bg-gray-50 transition-colors shadow-sm hover:shadow-md z-10 relative"
            >
              Try API Demo
            </Link>
          </div>
          <div className="mt-12">
            <p className="text-gray-500">No credit card required • No, we're not kidding • Seriously, it's free</p>
          </div>
        </div>
      </div>
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 mt-12 lg:mt-20 lg:pb-20">
        <div className="overflow-hidden rounded-2xl border border-gray-200 bg-gradient-to-br from-white to-gray-50 shadow-2xl backdrop-blur-sm relative z-10">
          <div className="p-8">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="h-2 w-full bg-gradient-to-r from-gray-200 to-gray-100 rounded"></div>
                  <div className="h-2 w-3/4 bg-gradient-to-r from-gray-200 to-gray-100 rounded"></div>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="h-2 w-full bg-gradient-to-r from-gray-200 to-gray-100 rounded"></div>
                  <div className="h-2 w-4/5 bg-gradient-to-r from-gray-200 to-gray-100 rounded"></div>
                  <div className="h-2 w-2/3 bg-gradient-to-r from-gray-200 to-gray-100 rounded"></div>
                </div>
              </div>
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {['React', 'Node.js', 'TypeScript', 'AWS', 'Docker', 'MongoDB'].map((skill) => (
                    <span
                      key={skill}
                      className="px-3 py-1 text-xs rounded-full bg-gradient-to-r from-blue-50 to-blue-100 text-blue-700 border border-blue-200"
                    >
                      {skill}
                    </span>
                  ))}
            ...
            <div className="mt-8 flex justify-center space-x-4">
              <button className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors shadow-sm hover:shadow">
                Export PDF
              </button>
              <button className="rounded-lg border border-gray-300 px-4 py-2 text-sm font-medium text-gray-700 hover:bg-gray-50 transition-colors shadow-sm hover:shadow">
                Export JSON
