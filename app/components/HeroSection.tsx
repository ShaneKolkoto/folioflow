  ...
  return (
    <section className="relative overflow-hidden min-h-screen">
        ...
        <div className="text-center relative z-10">
          ...
          <div className="mt-10 flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              ...
              className="inline-flex items-center justify-center rounded-lg bg-blue-600 px-8 py-3 text-lg font-medium text-white hover:bg-blue-700 dark:bg-blue-500 dark:hover:bg-blue-600 transition-colors shadow-lg hover:shadow-xl z-10 relative"
            >
              Start Building Free
            </Link>
            <Link
              href="/api-demo"
              className="inline-flex items-center justify-center rounded-lg border border-gray-300 px-8 py-3 text-lg font-medium text-gray-700 hover:bg-gray-50 dark:border-gray-600 dark:text-gray-300 dark:hover:bg-[#2C2C2E] transition-colors shadow-sm hover:shadow-md z-10 relative"
            >
              Try API Demo
            </Link>
          </div>
      ...
      <div className="relative mx-auto max-w-6xl px-4 sm:px-6 lg:px-8 mt-12 lg:mt-20 lg:pb-20">
        <div className="overflow-hidden rounded-2xl border border-[#2C2C2E] bg-gradient-to-br from-[#1D1D1F] to-[#242426] shadow-2xl relative z-10">
          <div className="p-8">
            ...
            <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="h-2 w-full bg-gradient-to-r from-gray-700 to-gray-600 rounded"></div>
                  <div className="h-2 w-3/4 bg-gradient-to-r from-gray-700 to-gray-600 rounded"></div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  <div className="h-2 w-full bg-gradient-to-r from-gray-700 to-gray-600 rounded"></div>
                  <div className="h-2 w-4/5 bg-gradient-to-r from-gray-700 to-gray-600 rounded"></div>
                  <div className="h-2 w-2/3 bg-gradient-to-r from-gray-700 to-gray-600 rounded"></div>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex flex-wrap gap-2">
                  {[
                    ...
                    <span
                      key={skill}
                      className="px-3 py-1 text-xs rounded-full bg-gradient-to-r from-blue-800 to-blue-700 text-blue-200 border border-blue-600"
                    >
                      {skill}
                    </span>
                  ))}
